...
:class:`ekf_tracker.manipulation.grasp_owner_detector.GraspOwnerDetector` (geometric
...
class GripperPhaseTracker:
    ...
    :class:`ekf_tracker.manipulation.grasp_owner_detector.TrackerState` (a small
