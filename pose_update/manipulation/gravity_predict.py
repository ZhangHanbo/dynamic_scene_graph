...
voxel observability grid (`pose_update.perception.voxel_observability`) to find
...
`docs/latex/bernoulli_ekf.tex`, "Gravity-aware predict at release"):
    ...
    *,
    ...
    Args:
        ...
        dyn: dynamics property (resolved via
            `pose_update.manipulation.object_dynamics.lookup_dynamics(label)`).
