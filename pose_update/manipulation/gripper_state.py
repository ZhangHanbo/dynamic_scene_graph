...
:class:`pose_update.manipulation.grasp_owner_detector.GraspOwnerDetector` (geometric
...
class GripperPhaseTracker:
    ...
    :class:`pose_update.manipulation.grasp_owner_detector.TrackerState` (a small
