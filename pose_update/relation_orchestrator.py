...
trigger gate in :mod:`pose_update.relation_utils`, smooths per-call
...
:func:`pose_update.relation_utils.expand_held_with_relations`.
...
class RelationOrchestrator:
    ...
    Backends:
        - ``"llm"``: :class:`pose_update.relation_client.LLMRelationClient`
          (default).
        - ``"rest"``: :class:`pose_update.relation_client.RESTRelationClient`.
