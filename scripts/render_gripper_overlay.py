...
Usage:
    python scripts/render_gripper_overlay.py FRAME [--trajectory NAME] [--out PATH]

    python scripts/render_gripper_overlay.py 488                     # default trajectory
    python scripts/render_gripper_overlay.py 487 488 495 600 998     # multiple frames
...
from utils.gripper_geometry import AABB, GripperGeometry  # noqa: E402
from utils.robot_models import create_gripper_geometry      # noqa: E402
